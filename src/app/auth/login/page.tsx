// app/auth/login/page.tsx - Page de connexion avec Firebase
"use client";
...
// Note: Les métadonnées doivent être dans un Server Component séparé
// Pour l'instant, on utilise un Client Component pour la logique
