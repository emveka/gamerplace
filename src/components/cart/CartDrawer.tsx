          ...
          <div className="border-t bg-gray-50 p-4 space-y-4 flex-shrink-0">
            ...
            <div className="space-y-2">
              <Link
                href="/checkout"
                onClick={closeCart}
                className="w-full bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-3 px-4 text-center block rounded transition-colors"
              >
              ...
              <Link
                href="/cart"
                onClick={closeCart}
                className="w-full bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 text-center block rounded transition-colors text-sm"
              >
